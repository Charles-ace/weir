...
| **Interactive Web Frontend** | Next.js 14 / Tailwind CSS | **REAL** | Production-compiled Next.js dashboard structured on Tier A reference (`dusk.network`). Live state tracking, Sepolia deposit trigger, 4-phase Attestcoin telemetry pill, and 3-investor claim panels. |
