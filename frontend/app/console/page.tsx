...
export default function ConsolePage() {
  ...
  return (
    <div className="min-h-screen bg-[#E2DFE9] text-[#101010] font-sans antialiased selection:bg-[#71B1FF] selection:text-black">
      ...
      {/* Header */}
      <section className="w-full max-w-[1550px] mx-auto px-4 sm:px-6 lg:px-12 pt-6 pb-8">
        <div className="relative rounded-[28px] sm:rounded-[36px] bg-[#101010] text-white p-8 sm:p-12 shadow-2xl overflow-hidden">
          <div 
          ...
          <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
            <div className="space-y-2">
              <div className="inline-flex items-center gap-2 text-xs font-mono font-bold uppercase tracking-[0.16em] text-[#71B1FF]">
                ...
                <span>INSTITUTIONAL SETTLEMENT CONSOLE</span>
              </div>
              <h1 className="text-3xl sm:text-5xl font-medium tracking-tight">
                Live RWA Settlement Workstation
              </h1>
              <p className="text-xs sm:text-sm text-[#A8A5AF] max-w-2xl">
                Execute cross-chain revenue inflows, trigger tenant covenant shortfalls, witness consensus verification via Precompile 0x0FD2, and perform O(1) investor pull-claims.
              </p>
            </div>

            <div className="flex items-center gap-3 font-mono text-xs">
              <span className="px-3 py-1.5 rounded-full bg-[#090D15] border border-[#2E2D30] text-[#A8A5AF] flex items-center gap-2">
                <span className="w-2 h-2 rounded-full bg-[#71B1FF] animate-pulse"></span>
                <span>Sepolia &amp; CC3 Linked</span>
              </span>
            </div>
          </div>
        </div>
      ...
      {/* 1. CONTRACT REGISTRY DRAWER */}
      <section className="w-full max-w-[1550px] mx-auto px-4 sm:px-6 lg:px-12 pb-8">
      ...
      {/* 2. THE 3-PANEL SETTLEMENT WORKSTATION */}
